 ...
 */
class CRM_Lockcase_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Lockcase_Upgrader(
        'uk.co.compucorp.atl.lockcase',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Lockcase_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
